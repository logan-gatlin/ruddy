...
pub const TAIL_RECURSION_MESSAGE: &str = "This function can be rewritten as tail recursion. Accumulate the addition before each recursive call instead of retaining work after it.";
