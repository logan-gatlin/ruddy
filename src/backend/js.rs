...
const NODE_ENTRY: &str = concat!(
    ...
    "let with_platform: (() -> 'a + !IO + !Exit + !FileSystem + !Process + !Path + !Http + !Host + !Random + !Assert + !Immediate) -> 'a + !Immediate = fn body => handle body () with\n",
        ...
        match &instr.op {
            ...
            Op::Reflect {
                ...
                out.push_str(match kind {
                    ...
                    crate::reification::Intrinsic::TypeInfo => "$typeInfo(",
                    crate::reification::Intrinsic::InfoOf => "$typeInfo(",
                    crate::reification::Intrinsic::DescribeInfo => "$describe(",
                    crate::reification::Intrinsic::SameInfo => "$sameMirror(",
                    crate::reification::Intrinsic::ShapeInfo => "$shapeInfo(",
                    crate::reification::Intrinsic::MirrorInfo => "$typeInfo(",
                    crate::reification::Intrinsic::Construct => "$construct(",
