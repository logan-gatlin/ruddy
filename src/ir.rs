...
/// Unit, as data: the empty struct, spanning what stood for it — a bare `@key`
/// or a bare tag's name.
fn unit_data(span: Span) -> Data {
    span.track(DataKind::Struct(IndexMap::new()))
}
