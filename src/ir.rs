...
impl Builder<'_> {
    ...
    fn ty(&mut self, ty: parse::Type, place: Place) -> Type {
        ...
        match ty.tracked {
            ...
            // declaration, which says the same thing wherever it is used and so
            // has nothing to leave open. Refused there and absorbed, the way an
            // open row written there is.
