...
fn metadata_diagnostics_are_pinned() {
    ...
    let mut map = SourceMap::default();
    let again = map.record(Symbol::GENERATED, 0, Span::generated(6, 2));
    let first = map.record(Symbol::GENERATED, 0, Span::generated(0, 2));
    ...
    let below = map.record(Symbol::GENERATED, 0, Span::generated(40, 2));
    let deep = ir::Error {
        at: below,
